...
var query = "select st.status, ped.id id, ped.empresa_id, ped.descrServ, ped.descAdicional, emp.id as empresaID, emp.imagemLogo as Logo, emp.razao, emp.endereco, emp.numero, emp.complemento, emp.bairro, emp.cidade, emp.uf , emp.cep cep, emp.telefone, emp.email, emp.cnpj, emp.site, ped.obs_que_nao_sai_na_nota, ped.totalGeral, ped.frete, ped.subtotal as subtotal " +
